...
typedef struct
{
    ...
    int MLX90640_DumpEE(uint8 slaveAddr, uint16 *eeData);
    int MLX90640_SynchFrame(uint8 slaveAddr);
    int MLX90640_TriggerMeasurement(uint8 slaveAddr);
    int MLX90640_GetFrameData(uint8 slaveAddr, uint16 *frameData);
    ...
    int MLX90640_SetResolution(uint8 slaveAddr, uint8 resolution);
    int MLX90640_GetCurResolution(uint8 slaveAddr);
    int MLX90640_SetRefreshRate(uint8 slaveAddr, uint8 refreshRate);   
    int MLX90640_GetRefreshRate(uint8 slaveAddr);  
    int MLX90640_GetSubPageNumber(uint16 *frameData);
    int MLX90640_GetCurMode(uint8 slaveAddr); 
    int MLX90640_SetInterleavedMode(uint8 slaveAddr);
    int MLX90640_SetChessMode(uint8 slaveAddr);
